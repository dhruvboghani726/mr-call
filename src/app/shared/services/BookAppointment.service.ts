...
export class BookAppoinmentService {
    ...
    BookAppointment(DoctorId: string, Mrid: string, AppointmentDate: string, StartTime: string, EndTime: string,) {
        return this.restmanagerService.add<BookAppointment>(`/api/MR/BookAppointment`, {
            DoctorId: DoctorId,
            Mrid: Mrid,
    ...
    FavoriteDoctor(doctorId: string, mrId: string) {
        ...
        return this.http.post<any>(`${environment.apiUrl}/api/Doctor/AddToMyList`, {
            doctorId, mrId,
        })
            .pipe(map(res => {
                console.log(res);
    ...
    doctorlistbymr(mrId) {
        return this.restmanagerService.getWithParametersdata<DoctorListByMr>(`/api/MR/DoctorListByMr`, { mrId: mrId })
            .pipe(map(data => {
                return data;
            }));
    }
    ...
    SearchDoctor(city, data, mrId) {
        ...
        return this.restmanagerService.getWithParametersdata<SearchDoctor>(`/api/Doctor/SearchDoctor`, { city: city, data: data, mrId: mrId })
            .pipe(map(data => {
                return data;
            }))
    }
    ...
    MrViewappoinment(appointmentId) {
        ...
        return this.restmanagerService.getWithParametersdata<viewAppoinment>(`/api/MR/ViewAppointment`, { appointmentId: appointmentId })
            .pipe(map(data => {
                return data;
            }))
    }
    DrViewappoinment(doctorId) {
        ...
        return this.restmanagerService.getWithParametersdata<Drviewappoinment>(`/api/MR/ViewAppointmentByDoctor`, { doctorId: doctorId })
            .pipe(map(data => {
                return data;
            }))
    }
